...
def createtree_2(key,headerTable,result,min_support):
	new_headerTable={}
	#print key
	#print
	CPB=[]
	...
	if CPB!=[]:
		...
		for keyy in new_headerTable:
			createtree_2(keyy,new_headerTable,result,min_support)
	elif headerTable[key].occur>=min_support:
		result.append(key)
...
#create FP-tree
headerTable=[]
headerTable.append(createtree_1(list5))

result=[]
for key in headerTable[0]:
	result.append([])
	createtree_2(key,headerTable[0],result[-1],min_support)
print result
'''
